...
#
# Usage:
#   sbatch runner_staged_partial_ft_v3_es.sh
#   TRAIN_DATASET=colon sbatch runner_staged_partial_ft_v3_es.sh
#   RUN_STAGE3=1 sbatch runner_staged_partial_ft_v3_es.sh
# =============================================================================
...
#SBATCH --job-name=bp_staged_ft_v3_es
#SBATCH --output=/home/roba/miccai26/logs/finetune_staged_v3_es_%j.out
#SBATCH --error=/home/roba/miccai26/logs/finetune_staged_v3_es_%j.err
...
OUTPUT_ROOT="${OUTPUT_ROOT:-/adialab/usr/roba/train_output/histopath_staged_v3_es}"
