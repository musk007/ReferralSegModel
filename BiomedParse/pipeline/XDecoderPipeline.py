...
class XDecoderPipeline:
    ...
    def initialize_model(self):
        ...
        lora_cfg = self._opt.get("SOLVER", {}).get("LORA", {})
        ...
        if is_evaluation:
            ...
            if not hasattr(self, 'train_loader'):
                ...
                try:
                    ...
                    _n = -1  # TrainingSampler is infinite; length is unknown
                logger.info(f'num of train samples: {_n}')
            else:
            ...
            try:
                ...
                steps_total = 1  # infinite sampler — no within-epoch LR step decay
