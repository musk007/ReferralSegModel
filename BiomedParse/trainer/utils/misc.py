...
def move_batch_to_device(batch, device):
    ...
    if torch.is_tensor(batch):
        ...
        #     print("*"*20)
        #     print("FILE NAME")
        #     print(batch[i]['file_name'])
        #     print("*"*20)
        #     print("\nIMAGE ID")
        #     print(batch[i]['image_id'])
        #     print("*"*20)
        #     print("\nGROUNDING INFO")
        #     print(batch[i]['grounding_info'])
        #     print("*"*20)
        #     print("\nWIDTH")
        #     print(batch[i]['width'])
        #     print("*"*20)
        #     print("\nHEIGHT")
        #     print(batch[i]['height'])
        #     print("*"*20)
        #     print("\IMAGE")
        #     print(batch[i]['image'].shape)
        #     print("*"*20)
        #     print("\nGROUNDINGS")
        #     print(batch[i]['groundings'].keys())
        #     print("*"*20)
        #     # print("\nGROUNDINGS MASKS")
        #     # print(batch[i]['groundings']["masks"])
        #     # print("*"*20)
        #     # print("\nGROUNDINGS TEXTS")
        #     # print(batch[i]['groundings']["texts"])
        #     # print("*"*20)
        #     # print("\nGROUNDINGS MODE")
        #     # print(batch[i]['groundings']["mode"])
        #     # print("*"*20)
        #     # print("\nGROUNDINGS HASH")
        #     # print(batch[i]['groundings']["hash"])
        #     # print("*"*20)
        #     # print("\INSTANCES")
        #     # print(batch[i]['instances'])
        #     # print("*"*20)
        #     # print("\nSPATIAL QUERY")
        #     # print(batch[i]['spatial_query'].keys())
        #     # print("*"*20)
        #     # print("\nSPATIAL QUERY GT MASKS")
        #     # print(batch[i]['spatial_query']["gt_masks"])
        #     # print("*"*20)
        #     # print("\nSPATIAL QUERY RAND SHAPE")
        #     # print(batch[i]['spatial_query']["rand_shape"])
        #     # print("*"*20)
        #     # print("\nSPATIAL QUERY TYPES")
        #     # print(batch[i]['spatial_query']["types"])
        #     # print("*"*20)
        #     # print("\nSPATIAL QUERY SAMPLER")
        #     # print(batch[i]['spatial_query']["sampler"])
        #     # print("*"*20)
        # import sys; sys.exit()
