...
OUTPUT_DIR="${OUTPUT_DIR:-${DATASETS_DIR}/output/histopath_nolora_single}"
...
BATCH_SIZE_PER_GPU="${BATCH_SIZE_PER_GPU:-1}"  # reduce if OOM; effective batch = BATCH_SIZE_TOTAL × GRAD_ACC_STEPS
