...
# sortedubclass_labels = [
#     1, 1, 1,    # ← 3 prototypes of invasive carcinoma
#     0, 0, 0,    # ← 3 prototypes of benign (absent)
#     1, 1, 1,    # ← 3 prototypes of immune cells
#     0, 0, 0     # ← 3 prototypes of necrosis (absent)
# ] 